...
| Figure 3 | Figure | Decision-layer guidance for strategy selection under operational constraints. | `paper_submission_ieom/figures/strategy_selection_guide.tex` | Yes | Yes | Yes | Caption below figure | Converts evidence into operational strategy selection. |
| Table 2 | Table | Strategy families and operating conditions. | `paper_submission_ieom/tables/strategy_guidance_table.tex` | Yes | Yes | Yes | Title above table | Maps operating conditions to policy choices. |
