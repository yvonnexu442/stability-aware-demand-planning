...
\textbf{4. Model Switching Burden} (implicit in loss function): Each model change requires validation, approval, and monitoring. These governance processes take time and resources regardless of whether the new model is more accurate; we measure the number of model changes to quantify this burden. Aggregating execution violations over time gives the \textbf{planning-execution gap rate}, the fraction of periods where the operation cannot execute:
\begin{equation}
