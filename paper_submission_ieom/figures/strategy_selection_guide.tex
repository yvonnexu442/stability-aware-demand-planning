...
% ===== Bottom note =====
\node[note] at (8.0,5.15) {Read the three lanes independently, then prioritize the most operationally binding constraint.\\ For example, a hard governance ceiling overrides an accuracy preference (Table~\ref{tab:strategy-guidance} lists the full mapping).};
