# IEOM Compliance Checklist

## Manuscript Structure

- [x] Title is related to industrial engineering and operations management.
- [x] Abstract is under 250 words.
- [x] Exactly five keywords are included.
...
- [x] Tables are numbered as Table 1, Table 2, and so on.
- [x] Table titles appear above tables.
...
- [x] Every in-text citation appears in the reference list.
- [x] Citation details were checked where possible; unresolved citation details were not fabricated.
